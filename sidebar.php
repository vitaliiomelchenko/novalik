...
if ( in_array( $porto_layout, porto_options_sidebars() ) ) :
	?>
	<div class="col-lg-3 col-12 sidebar <?php echo 'porto-' . $porto_sidebar; ?> <?php echo str_replace( 'both-', 'left-', str_replace( 'wide-', '', $porto_layout ) ); ?><?php echo porto_filter_output( $mobile_sidebar ? ' mobile-sidebar' : '' ); ?>"><!-- main sidebar -->
        <div class="mobile_categories_opener">
            Категорії Товарів
        </div>
