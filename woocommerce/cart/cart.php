...
<div class="cart_container">
	...
	<div class="row">
		<div class="col-lg-8 cart_table_wrapper">
											...
											<div class="cart_totals_toggle">
												<div class="card card-default">
													<div class="card-header arrow">
														<h2 class="card-title"><a class="accordion-toggle collapsed" data-toggle="collapse" href="#panel-cart-discount"><?php esc_html_e( 'Coupon', 'porto' ); ?></a></h2>
													</div>
													<div id="panel-cart-discount" class="accordion-body collapse">
														<div class="card-body">
															<div class="coupon">
																<label for="coupon_code"><?php _e( 'Промокод', 'woocommerce' ); ?></label>
																<input type="text" name="coupon_code" class="input-text" id="coupon_code" placeholder="<?php _e( 'Промокод', 'woocommerce' ); ?>" value="" />
																<button type="submit" class="btn btn-primary" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply', 'woocommerce' ); ?></button>
		...
		<div class="col-lg-4 cart_total_wrapper">
